                        ...
                        <form action="">
                            <VLayout style={styles.RegisterForm}>
                                <div style={styles.RegisterFormItem}>
                                   ...
                                   <input style={styles.RegisterFormItemInput} placeholder='输入用户名' type="text" />
                                </div>
                                <div  style={styles.RegisterFormItem}>
                                    <div  style={styles.RegisterFormItemHeader}>邮箱</div>
                                    <input style={styles.RegisterFormItemInput} placeholder='输入邮箱' type="text" />
                                </div>
                                <div  style={styles.RegisterFormItem}>
                                    <div  style={styles.RegisterFormItemHeader}>密码</div>
                                   <input style={styles.RegisterFormItemInput} placeholder='输入密码' type="password" />
                                </div>
                                <div  style={styles.RegisterFormItem}>
                                    <div  style={styles.RegisterFormItemHeader}>确认密码</div>
                                    <input style={styles.RegisterFormItemInput} placeholder='确认密码' type="password" />
                               </div>
                                <div  style={styles.RegisterFormItem}>
